...
// NGECEK SCOURING di RECIPE 001, KALAU ADA INSERT DULUAN DATA PALING ATAS
    ...
    if($suffix['jenis_matching'] == 'Matching Ulang' OR $suffix['jenis_matching'] == 'Matching Ulang NOW' OR $suffix['jenis_matching'] == 'Matching Development'){
        ...
        if(!empty($data_scouring['SUBCODE01'])){
            ...
            $queryDataMainComponents = "INSERT INTO RECIPECOMPONENTBEAN(FATHERID,
                                                                        IMPORTAUTOCOUNTER,
                                                                        OWNEDCOMPONENT,
                                                                        RECIPEITEMTYPECODE,
                                                                        RECIPESUBCODE01,
                                                                ...
                                                                VALUES(
                                                                    ...
                                                                    '$no_urut', 
                                                                    '$userLogin')";
            $insert_recipeComponentBean = db2_exec($conn1, $queryDataMainComponents);
        }
    }
// NGECEK SCOURING di RECIPE 001, KALAU ADA INSERT DULUAN DATA PALING ATAS
while ($r_cmp = $recipe_cmp->fetch_assoc()) {
    ...
    if ($r_cmp['kode'] == 'B-L-C') {
        ...
        $queryDataMainBLC = "INSERT INTO RECIPECOMPONENTBEAN(FATHERID,
                                                            IMPORTAUTOCOUNTER,
                                                            OWNEDCOMPONENT,
                                                            RECIPEITEMTYPECODE,
                                                            RECIPESUBCODE01,
                                                    ...
                                                    '0',
                                                    '$no_urut')";
        $insert_recipeComponentBean_comment = db2_exec($conn1, $queryDataMainBLC);
        // TAMBAH UNTUK BLEACHING
    } elseif ($r_cmp['ket'] == 'Suhu') {
        // TAMBAH UNTUK COMMENT DITENGAH-TENGAH RESEP
        $_SEQUENCE = $SEQUENCE++ . '0';
        $commentname = str_replace("'", "`", $r_cmp['nama']);
        $queryDataMainSuhu = "INSERT INTO RECIPECOMPONENTBEAN(FATHERID,
                                                            IMPORTAUTOCOUNTER,
                                                            OWNEDCOMPONENT,
                                                            RECIPEITEMTYPECODE,
                                                            RECIPESUBCODE01,
                                                    ...
                                                    '0',
                                                    '$no_urut')";
        $insert_recipeComponentBean_comment = db2_exec($conn1, $queryDataMainSuhu);
        ...
        $queryDataMainDYC = "INSERT INTO RECIPECOMPONENTBEAN(FATHERID,
                                                            IMPORTAUTOCOUNTER,
                                                            OWNEDCOMPONENT,
                                                            RECIPEITEMTYPECODE,
                                                            RECIPESUBCODE01,
                                                    ...
                                                    '$no_urut', 
                                                    '$userLogin')";
        $insert_recipeComponentBean = db2_exec($conn1, $queryDataMainDYC);
    }
}
...
while ($r_cmp_suhu_bleaching_rc_soaping = $sql_suhu_menit->fetch_assoc()) {
    ...
    if ($r_cmp_suhu_bleaching_rc_soaping['COMMENTLINE'] != '0`C X 0 MNT' or $r_cmp_suhu_bleaching_rc_soaping['COMMENTLINE'] != 'SOAPING 0`C X 0 MNT' or $r_cmp_suhu_bleaching_rc_soaping['COMMENTLINE'] != 'BLEACHING 0`C X 0 MNT') { //kalau suhu dan menitnya kosong maka tidak usah di export
        $queryDataMainComment = "INSERT INTO RECIPECOMPONENTBEAN(FATHERID,
                                                                IMPORTAUTOCOUNTER,
                                                                OWNEDCOMPONENT,
                                                                RECIPEITEMTYPECODE,
                                                                RECIPESUBCODE01,
                                                        ...
                                                        '0',
                                                        '$no_urut')";
        $insert_recipeComponentBean_comment = db2_exec($conn1, $queryDataMainComment);
    }
}
