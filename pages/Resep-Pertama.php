                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="box-header text-center">
                                    <h4 class="box-title" style="font-weight: bolder;">Recap Data Resep Pertama <?php if ($_POST['start']) echo date("Y-m-d",strtotime($_POST['start']))." ".$_POST['time_start']. " S/d " . date("Y-m-d",strtotime($_POST['end']))." ".$_POST['time_end']; ?></h4>
                                </div>
                                <table class="table table-bordered table-hover" id="table_hasil">
                                    ...
                                    <?php
                                        ...
                                        session_start();
                                        include "koneksi.php";
										$start = date("Y-m-d",strtotime($_POST['start']))." ".$_POST['time_start'];
                                        $end = date("Y-m-d",strtotime($_POST['end']))." ".$_POST['time_end'];
                            ...
                            <div class="col-md-6">
                                <div class="box-header text-center">
                                    <h4 class="box-title" style="font-weight: bolder;">Recap Data Create Resep <?php if ($_POST['start']) echo date("Y-m-d",strtotime($_POST['start']))." ".$_POST['time_start']. " S/d " . date("Y-m-d",strtotime($_POST['end']))." ".$_POST['time_end']; ?></h4>
                                </div>
                                    ...
                                    if ($_POST['submit']) { ?>
                                        ...
                                        <?php
                                            $avg = mysqli_query($con,"SELECT sum(percobaan_ke) as summary,count(jenis_matching) as `row`, jenis_matching
                                                from tbl_status_matching a 
                                                join tbl_matching b on a.idm = b.no_resep
                                                where DATE_FORMAT(a.approve_at,'%Y-%m-%d %H:%i') >= '".date("Y-m-d",strtotime($_POST['start']))." ".$_POST['time_start']."' 
                                                AND DATE_FORMAT(a.approve_at,'%Y-%m-%d %H:%i') <= '".date("Y-m-d",strtotime($_POST['end']))." ".$_POST['time_end']."' 
