                            ...
                            <tbody id="tb-lookup1_now">
                                <?php 
                                    $query_recipe_cmp = "TRIM(r.ITEMTYPEAFICODE),
                                                        ...
                                                        WHERE TRIM(r.ITEMTYPEAFICODE) = 'DYC'"; 
                                ?>
                                <?php if (substr($sufix, 0, 2) == 'D2' or substr($sufix, 0, 1) == 'C') : ?>
                                    <?php 
                                        $recipeNumberD2CD = $_GET['D2CD'];
                                        $query_rcmpD2CD = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberD2CD'");
                                        $no = 1;
                                        while ($dt_rcmpD2CD = db2_fetch_assoc($query_rcmpD2CD)){
                                    ?>
                                    <tr>
                                        <td align="center" class="nomor"><?= $no++; ?></td>
                                        <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpD2CD['CODECMP']; ?>"></td>
                                ...
                                <?php elseif (substr($sufix, 0, 1) == 'R' or substr($sufix, 0, 1) == 'A') : ?>
                                    <?php 
                                        ...
                                        $query_rcmpRA = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberRA'");
                                        $no = 1;
                                        while ($dt_rcmpRA = db2_fetch_assoc($query_rcmpRA)){
                                    ?>
                                    <tr>
                                        <td align="center" class="nomor"><?= $no++; ?></td>
                                        <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpRA['CODECMP']; ?>"></td>
                                ...
                                <?php elseif(substr($sufix, 0, 2) == 'DR') : ?>
                                    <?php if($_GET['D'] && !($_GET['R'])) : ?>
                                        <?php 
                                            ...
                                            $query_rcmpD = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberD'");
                                            $no = 1;
                                            while ($dt_rcmpD = db2_fetch_assoc($query_rcmpD)){
                                        ?>
                                        <tr>
                                            <td align="center" class="nomor"><?= $no++; ?></td>
                                            <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpD['CODECMP']; ?>"></td>
                                    ...
                                    <?php elseif($_GET['R'] && !($_GET['D'])) : ?>
                                        <?php 
                                            ...
                                            $query_rcmpR = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberR'");
                                            $no = 1;
                                            while ($dt_rcmpR = db2_fetch_assoc($query_rcmpR)){
                                        ?>
                                        <tr>
                                            <td align="center" class="nomor"><?= $no++; ?></td>
                                            <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpR['CODECMP']; ?>"></td>
                                    ...
                                    <?php elseif($_GET['D'] && $_GET['R']) : ?>
                                        <?php 
                                            $recipeNumberD = $_GET['D'];
                                            $recipeNumberR = $_GET['R'];
                                            $query_rcmpDR = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberD' OR RECIPENUMBERID = '$recipeNumberR'");
                                            $no = 1;
                                            while ($dt_rcmpDR = db2_fetch_assoc($query_rcmpDR)){
                                        ?>
                                        <tr>
                                            <td align="center" class="nomor"><?= $no++; ?></td>
                                            <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpDR['CODECMP']; ?>"></td>
                                ...
                                <?php elseif(substr($sufix, 0, 2) == 'OB') : ?>
                                    <?php 
                                        ...
                                        $query_rcmpOB = db2_exec($conn1, "SELECT $query_recipe_cmp AND RECIPENUMBERID = '$recipeNumberOB'");
                                        $no = 1;
                                        while ($dt_rcmpOB = db2_fetch_assoc($query_rcmpOB)){
                                    ?>
                                    <tr>
                                        <td align="center" class="nomor"><?= $no++; ?></td>
                                        <td><input style="width: 100%" type="text" class="form-control input-xs code" value="<?= $dt_rcmpOB['CODECMP']; ?>"></td>
                            ...
                            <?php if (substr($sufix, 0, 2) == 'D2' or substr($sufix, 0, 1) == 'C') { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            $numbidD2CD = $_GET['D2CD'];
                                            $query_tSideD2CD = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                        ...
                                        ?>
                                        <input type="text" width="100%" class="form-control" required name="tside_c" value="" id="tside_c" placeholder="C°...">
                                        <!-- <input type="text" width="100%" class="form-control" required name="tside_c" value="<?= $dt_tSideD2CD['COMMENTLINE']; ?>" id="tside_c" placeholder="C°..."> -->
                                    </div>
                                ...
                                <?php
                                    $numbidD2CD = $_GET['D2CD'];
                                    $query_D2CD = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                    WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                                                        AND RECIPENUMBERID = '$numbidD2CD'");
                                    while($dt_D2CD = db2_fetch_assoc($query_D2CD)){
                                    if(str_contains($dt_D2CD['COMMENTLINE'], 'SOAPING')){
                                        $soaping = substr($dt_D2CD['COMMENTLINE'], 8);
                                    }
                                    if(str_contains($dt_D2CD['COMMENTLINE'], 'RC')){
                                        $rc = substr($dt_D2CD['COMMENTLINE'], 3);
                                    }
                                    if(str_contains($dt_D2CD['COMMENTLINE'], 'BLEACHING')){
                                        $bleaching = substr($dt_D2CD['COMMENTLINE'], 10);
                                    }
                                    }
                                ?>
                                <div class="form-group" style="margin-top: 10px; padding: 5px;">
                                    ...
                                    <div class="input-group col-md-5">
                                        <input type="text" class="form-control" required id="RC_Suhu" name="RC_Suhu" value="" placeholder="Suhu">
                                        <!-- <input type="text" class="form-control" required id="RC_Suhu" name="RC_Suhu" value="<?= $rc; ?>" placeholder="Suhu"> -->
                            ...
                            <?php } elseif (substr($sufix, 0, 1) == 'R' or substr($sufix, 0, 1) == 'A') { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            $numbidRA = $_GET['RA'];
                                            $query_cSideRA = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                                WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                        ...
                                        ?>
                                        <input type="text" width="100%" class="form-control" required value="" name="cside_c" id="cside_c" placeholder="C°...">
                                        <!-- <input type="text" width="100%" class="form-control" required value="<?= $dt_cSideRA['COMMENTLINE']; ?>" name="cside_c" id="cside_c" placeholder="C°..."> -->
                                    </div>
                                    <label for="tside_min" style="width: 10px;" class="col-sm-1 control-label"><i class="fa fa-times" aria-hidden="true"></i>
                                    </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group" style="margin-top: 10px; padding: 5px;">
                                    ...
                                    <div class="input-group col-md-5">
                                        <?php
                                            $numbidRA = $_GET['RA'];
                                            $query_RA = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                            WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                                                                AND RECIPENUMBERID = '$numbidRA'");
                                            
                                             while($dt_RA = db2_fetch_assoc($query_RA)){
                                                if(str_contains($dt_RA['COMMENTLINE'], 'SOAPING')){
                                                    $soaping = substr($dt_RA['COMMENTLINE'], 8);
                                                }
                                            }
                                        ?>
                                        <input type="text" class="form-control" required id="soapingSuhu" value="" name="soapingSuhu" placeholder="Suhu">
                                        <!-- <input type="text" class="form-control" required id="soapingSuhu" value="<?= $soaping; ?>" name="soapingSuhu" placeholder="Suhu"> -->
                                        <div class="input-group-addon">°C</div>
                                    </div>
                            ...
                            <?php } elseif (substr($sufix, 0, 2) == 'DR') { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            $numbidD = $_GET['D'];
                                            $query_tSideD = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                                WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                        ...
                                        ?>
                                        <input type="text" width="100%" class="form-control" required name="tside_c" value="" id="tside_c" placeholder="C°...">
                                        <!-- <input type="text" width="100%" class="form-control" required name="tside_c" value="<?= $dt_tSideD['COMMENTLINE']; ?>" id="tside_c" placeholder="C°..."> -->
                                    </div>
                                    <label for="tside_min" style="width: 10px;" class="col-sm-1 control-label"><i class="fa fa-times" aria-hidden="true"></i>
                                    </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            $numbidR = $_GET['R'];
                                            $query_tSideR = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                                WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                        ...
                                        ?>
                                        <input type="text" width="100%" class="form-control" value="<?= $dt_tSideR['COMMENTLINE']; ?>" required name="cside_c" id="cside_c" placeholder="C°...">
                                    </div>
                                    <label for="tside_min" style="width: 10px;" class="col-sm-1 control-label"><i class="fa fa-times" aria-hidden="true"></i>
                                    </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group" style="margin-top: 10px; padding: 5px;">
                                    ...
                                    <div class="input-group col-md-5">
                                        <?php
                                            ...
                                            $numbidR = $_GET['R'];
                                            if($numbidD && !($numbidR)) {
                                                $query_SRB = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                                WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                                                                    AND RECIPENUMBERID = '$numbidD'");
                                             ...
                                             while($dt_SRB = db2_fetch_assoc($query_SRB)){
                                                if(str_contains($dt_SRB['COMMENTLINE'], 'SOAPING')){
                                                    $soaping = substr($dt_SRB['COMMENTLINE'], 8);
                                                }
                                                if(str_contains($dt_SRB['COMMENTLINE'], 'RC')){
                                                    $rc = substr($dt_SRB['COMMENTLINE'], 3);
                                                }
                                                if(str_contains($dt_SRB['COMMENTLINE'], 'BLEACHING')){
                                                    $bleaching = substr($dt_SRB['COMMENTLINE'], 10);
                                                }
                                            }
                                        ?>
                                        <input type="text" class="form-control" required id="soapingSuhu" value="" name="soapingSuhu" placeholder="Suhu">
                                ...
                                <div class="form-group" style="margin-top: 10px; padding: 5px;">
                                    <label for=" RC" class="col-sm-2 control-label" align="left">Bleaching</label>
                                    <div class="input-group col-md-5">
                                        <input type="text" class="form-control" id="bleaching_sh" value="" required name="bleaching_sh" placeholder="Suhu">
                                        <!-- <input type="text" class="form-control" id="bleaching_sh" value="<?= $bleaching; ?>" required name="bleaching_sh" placeholder="Suhu"> -->
                                        <div class="input-group-addon">°C</div>
                                    </div>
                                    <label for="RC" class="col-sm-2 control-label" align="left">-</label>
                                    <div class="input-group col-md-5">
                            ...
                            <?php } elseif (substr($sufix, 0, 2) == 'OB') { ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            $numbidOB = $_GET['OB'];
                                            $query_tSideOB = db2_exec($conn1, "SELECT TRIM(COMMENTLINE) AS COMMENTLINE FROM RECIPECOMPONENT 
                                                                                WHERE TRIM(RECIPEITEMTYPECODE) = 'RFD' 
                                        ...
                                        ?>
                                        <input type="text" width="100%" class="form-control" required value="" name="tside_c" id="tside_c" placeholder="C°...">
                                        <!-- <input type="text" width="100%" class="form-control" required value="<?= $dt_tSideOB['COMMENTLINE']; ?>" name="tside_c" id="tside_c" placeholder="C°..."> -->
                                    </div>
                                    <label for="tside_min" style="width: 10px;" class="col-sm-1 control-label"><i class="fa fa-times" aria-hidden="true"></i>
                                    </label>
                                    <div class="col-sm-2">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql_recipe = db2_exec($conn1, "SELECT 
                                                                            ...
                                                                            FROM RECIPE WHERE ITEMTYPECODE = 'RFD' AND TRIM(SUFFIXCODE) = '$sufix'");
                                            $no = 1; 
    ...
    $(document).ready(function() {
        ...
        function Hold_action_after_check_table() {
            ...
            Update_StatusMatching_ToHold($("#id_matching").val(), $("#id_status").val(), $("#idm").val(), $('#Matching-ke').val(), $('#BENANG-A').val(), $("#LEBAR-A").val(), $("#GRAMASI-A").val(), $("#L_R").find('option:selected').val(), $("#kadar_air").val(), RC_Suhu, RCWaktu, soapingSuhu, soapingWaktu, $("#CIE_WI").val(), $("#CIE_TINT").val(), $("#Spektro_R").val(), $("#Done_Matching").val(), $("#keterangan").val(), $("#tgl_buat_status").val(), tside_c, tside_min, cside_c, cside_min, $('#kadar_air_true').val(), $('#CocokWarna').val(),
                ...
                $("#colorist_2").find('option:selected').val(), $("#Proses").find('option:selected').val(), $("#item").val(), $('#no_warna').val(), $('#warna').val(), $('#Kain').val(), $('#Benang').val(), $('#Lebar').val(), $('#Gramasi').val(), $('#Tgl_delivery ').val(), $('#Order').val(), $('#po_greige').val(), $('#QtyOrder').val(), $('#Matcher').find('option:selected').val(), $('#Group').find('option:selected').val(), $("#Buyer").find('option:selected').val(), bleaching_sh, bleaching_tm, $('#second_lr').find(':selected').val())
        }

        function Update_StatusMatching_ToHold(id_matching, id_status, idm, matching_ke, benang_a, lebar_a, gramasi_a, l_R, kadar_air, RC_Suhu, RCWaktu, soapingSuhu, soapingWaktu, cie_wi, cie_tint, Spektro_R, Done_Matching, keterangan, tgl_buat_status, tside_c, tside_min, cside_c, cside_min, kadar_air_true, cocok_warna, final_matcher, koreksi_resep, colorist1, colorist2, proses, item, no_warna, warna, Kain, Benang, Lebar, Gramasi, Tgl_delivery, Order, po_greige, QtyOrder, Matcher, Group, Buyer, bleaching_sh, bleaching_tm, second_lr) {
            SpinnerShow()
            $.ajax({
                dataType: "json",
                type: "POST",
