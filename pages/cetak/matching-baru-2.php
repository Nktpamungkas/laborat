...
<table width="100%" border="0" class="table-list1">
  <tbody>
    ...
    <tr>
      <td width="77" style="border-right:0px #000000 solid;"><strong style="font-size: 22px;">R</strong><span>CODE</span></td>
      <td width="14" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="68" style="border-left:0px #000000 solid;"><strong><?Php echo $data['no_resep'];?></strong></td>
      <td width="82" style="border-right:0px #000000 solid;"><strong style="font-size: 22px;">I</strong>TEM</td>
      ...
      <td colspan="6" align="center" style="border-bottom:0px #000000 solid;"><strong style="font-size: 24px;">KARTU MATCHING</strong></td>
      <td width="87" style="border-right:0px #000000 solid;"><strong style="font-size: 22px;">L</strong>ANGGANAN</td>
      <td width="10" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="203" style="border-left:0px #000000 solid;"><strong style="font-size: 9px;"><?Php echo $data['langganan'];?></strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="67" rowspan="2">No. Program Celup</td>
      <td width="39" style="border-right:0px #000000 solid;">T-Side </td>
      <td width="60" style="border-left:0px #000000 solid;">:</td>
      <td width="54" rowspan="2">No. Gelas</td>
      <td width="44" style="border-right:0px #000000 solid;">T-Side </td>
      <td width="72" style="border-left:0px #000000 solid;">:</td>
    ...
    <tr>
      <td width="39" style="border-right:0px #000000 solid;">C-Side </td>
      <td width="60" style="border-left:0px #000000 solid;">:</td>
      <td width="44" style="border-right:0px #000000 solid;">C-Side </td>
      <td width="72" style="border-left:0px #000000 solid;">:</td>
    ...
    <tr>
      ...
      <td rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="46" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">&nbsp;</td>
      <td width="56" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;"><span style="border-left:0px #000000 solid;"><span style="border-right:0px #000000 solid;"><strong style="font-size: 21px;">C</strong>IE <strong style="font-size: 21px;">W</strong>I</span></span></td>
      <td width="7" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="22" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">&nbsp;</td>
      <td width="54" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;"><span style="border-left:0px #000000 solid;"><strong style="font-size: 8px;"><strong style="font-size: 21px;">C</strong>IE <strong style="font-size: 21px;">T</strong>INT</strong></span></td>
      <td width="7" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="26" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">&nbsp;</td>
    ...
    <tr>
      <td style="border-right:0px #000000 solid;">R.C. </td>
      <td style="border-left:0px #000000 solid;">:</td>
...
<table width="100%" border="0" class="table-list1">
  <tbody>
    ...
    <tr>
      ...
      <td align="center" style="height: 16px;"><?php echo strtoupper($r['kode']);?></td>
    ...
    <tr>
      <td align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
	  <td colspan="4" align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
      <td align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
      <td align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
      <td align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
      <td align="center" style="height: 16px; border-bottom: double;">&nbsp;</td>
    ...
    <tr>
      ...
      <td align="center" style="height: 16px;"><?php echo strtoupper($r1['kode']);?></td>
    ...
    <tr>
      ...
      <td rowspan="7" align="center">KAIN</td>
    ...
    <tr>
      <td align="center"><a style="font-size: 8px;">BleachingDYE</a></td>
      <td align="center"><a style="font-size: 8px;">
        <?php if($data['ck_bleaching']>0){?>
  &#10004;
  <?php } ?>
      </a></td>
    </tr>
    <tr>
      <td align="center"><a style="font-size: 8px;">BleachingLAB</a></td>
      <td width="2%" align="center"><a style="font-size: 8px;"><?php if($data['ck_bleaching_dye']>0){?>
        &#10004;
        <?php } ?>
      </a></td>
      <td width="4%" align="left">TL83</td>
      <td width="5%" align="center"><?php if($data['ck_tl83']>0){?>
        &#10004;
      <?php } ?></td>
    </tr>
    <tr>
