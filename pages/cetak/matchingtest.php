...
<head>
  ...
  <link href="styles_cetaktest11.css" rel="stylesheet" type="text/css">	
  ...
  <table width="100%" border="0" class="table-list1">
    <tbody>
      ...
      <tr><?php $i = 1;
        ...
        <td width="86" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;"><span style="border-left:0px #000000 solid;"><span style="border-right:0px #000000 solid;"><strong style="font-size: 21px;">C</strong>IE <strong style="font-size: 21px;">W</strong>I</span></span> :</td>
        <td width="16" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">&nbsp;</td>
        <td width="85" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;"><span style="border-left:0px #000000 solid;"><strong style="font-size: 8px;"><strong style="font-size: 21px;">C</strong>IE <strong style="font-size: 21px;">T</strong>INT</strong></span> :</td>
        <td width="33" rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">&nbsp;</td>
        <td style="border-right:0px #000000 solid;">PH </td>
        <td style="border-left:0px #000000 solid;">:</td>
        <td colspan="2">&nbsp;</td>
        <td rowspan="2" style="border-right:0px #000000 solid;"><strong style="font-size: 21px;">L</strong>AB <strong style="font-size: 21px;">D</strong>IP <strong style="font-size: 21px;">N</strong>O</td>
        <td rowspan="2" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
