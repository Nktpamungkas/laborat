  ...
  <!--style="width: 7.5in;"-->
      ...
      <td align="left" valign="top" style="height: 1.6in;"><table width="100%" border="0" class="table-list1" style="width: 2.3in;">
        <tbody>
          ...
          <tr>
            ...
            <td align="center" valign="middle" style="font-size:9px;"><strong>:</strong></td>
            <td style="font-size:9px;"><strong><?php if($r['tgl_update']!=""){echo date('d-m-Y H:i', strtotime(substr($r['tgl_update'],0,18)));}?></strong></td>
          </tr>
          <tr>
      ...
      <td align="left" valign="top" style="height: 1.6in;"><table width="100%" border="0" class="table-list1" style="width: 2.3in;">
        <tbody>
          ...
          <tr>
            <td style=" font-size:9px;"><strong>TANGGAL</strong></td>
            <td align="center" valign="middle" style="font-size:9px;"><strong>:</strong></td>
            <td style="font-size:9px;"><strong><?php if($r1['tgl_update']!=""){echo date('d-m-Y H:i', strtotime(substr($r1['tgl_update'],0,18)));}?></strong></td>
          </tr>
          <tr>
            <td style=" font-size:9px;"><strong>NAMA WARNA</strong></td>
            <td align="center" valign="middle" style="font-size:9px;"><strong>:</strong></td>
	...
	?>
          <tr>
            ...
            <td style=" font-size:9px;" align="center" valign="middle"><strong><?php echo $no + 1; ?></strong></td>
            <td style="font-size:9px;"><strong>
              <?php if(!empty($detail21[0])){ echo $detail21[0]; } else { echo "FULL TEST"; } ?>
            </strong></td>
          </tr>
          <?php
	  }
      ...
      <td align="left" valign="top" style="height: 1.6in;"><table width="100%" border="0" class="table-list1" style="width: 2.3in;">
        <tbody>
          ...
          <tr>
            <td style=" font-size:9px;"><strong>TANGGAL</strong></td>
            <td align="center" valign="middle" style="font-size:9px;"><strong>:</strong></td>
            <td style="font-size:9px;"><strong><?php if($r2['tgl_update']!=""){echo date('d-m-Y H:i', strtotime(substr($r2['tgl_update'],0,18)));}?></strong></td>
          </tr>
          <tr>
            <td style=" font-size:9px;"><strong>NAMA WARNA</strong></td>
            <td align="center" valign="middle" style="font-size:9px;"><strong>:</strong></td>
	...
	?>
          <tr>
            ...
            <td style=" font-size:9px;" align="center" valign="middle"><strong><?php echo $no + 1; ?></strong></td>
            <td style="font-size:9px;"><strong>
              <?php if(!empty($detail22[0])){ echo $detail22[0]; } else { echo "FULL TEST"; } ?>
            </strong></td>
          </tr>
          <?php
	  }
