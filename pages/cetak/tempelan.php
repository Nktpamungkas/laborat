...
session_start();
$con=mysqlii_connect("10.0.1.91","dit","4dm1n","db_laborat");
//--
$idkk = $_REQUEST['idkk'];
$act = $_GET['g'];
//-
...
<body>
  <?php
  $qry = mysqli_query($con,"SELECT *,DATE_FORMAT(now(),'%d %M %Y') as tgl FROM tbl_tempelan WHERE no_resep='$idkk'");
  ...
  <table width="100%" border="0" class="table-list1">
    <tr>
      ...
      <td width="1%" style="border-right:0px #000000 solid; border-left:0px #000000 solid;">:</td>
      <td width="12%" style="border-left:0px #000000 solid;"><strong><?Php if ($data['lebara'] != "") {
                                                                        echo $data['lebara'] . " x " . $data['gramasia'] . " gr/m2";
                                                                      } else {
                                                                        echo "<font color=white>" . $data['lebar_a'] . "</font>&nbsp;&nbsp;&nbsp;&nbsp; x <font color=white> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $data['gramasi_a'] . "</font> gr/m2";
                                                                      } ?></strong></td>
    </tr>
    <tr>
  ...
  <table width="100%" border="1" class="table-list1">
    ...
    <tr style="height: 0.4in">
      ...
      <td colspan="2" rowspan="2">
        <table width="100%" border="0">
          ...
          <tr>
            <td>BleachingDYE</td>
            <td align="center"><?php if ($data['ck_bleaching_dye'] > 0) { ?>
                &#10004;
              <?php } ?></td>
            <td>Peach</td>
    ...
    <tr style="height: 0.4in">
      <td colspan="2" align="center">RC / Bleaching</td>
      <td colspan="2">&nbsp;</td>
      <td colspan="3">&nbsp;</td>
    ...
    <tr style="height: 0.4in">
      <td colspan="3" align="center">BEFORE RC / Bleaching</td>
      <td colspan="4" align="center">AFTER RC / Bleaching</td>
    </tr>
