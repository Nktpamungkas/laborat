        ...
        <ul class="nav nav-tabs">
            ...
            <li class="pull-right">
                <?php if ($data['approve'] == 'NONE' && $data['status'] == 'selesai') : ?>
                    <button type="button" style="color: white; width: 150px;" class="btn btn-block btn-sm btn-success approve" idm="<?php echo $data['idm'] ?>" id_status="<?php echo $data['id_status'] ?>"><strong>Approve ! <i class="fa fa-check-circle"></strong></i></button>
                <?php else : ?>
