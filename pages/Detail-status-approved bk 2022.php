    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <li class="pull-right">
                ...
                <?php else : ?>
                    <a href="pages/cetak/cetak_resep.php?ids=<?php echo $data['id_status'] ?>&idm=<?php echo $data['idm'] ?>" style="width: 150px;" class="bbtn btn-block btn-sm btn-danger approve" target="_blank">Cetak Resep <i class="fa fa-fw fa-print"></i></a>
                <?php endif; ?>
            </li>
        </ul>
    </div>
