<?php
    ...
    if(substr(strtoupper($data['idm']), 0,2) == "DR" ){
        ...
        $CoderecipeD = substr($data['recipe_code'],0,15); 
        ...
        $CoderecipeR = substr($data['recipe_code'],17);
        ...
        $Coderecipe = substr($data['recipe_code'],0,15); 
        ...
        $sql_recipe = mysqli_query($con, "SELECT * FROM recipeprefix WHERE recipe_code = '$Coderecipe' AND suffix = '$suffix'");
        $data_recipe = mysqli_fetch_array($sql_recipe); 
    }
?>
<style>
    .lookupST {
        ...
        <div class="tab-content">
            ...
            <div id="export_recipe" class="tab-pane fade">
                <div class="col-md-12" style="margin-top: 10px;">
                    ...
                    <center>
                        <?php if(substr(strtoupper($data['idm']), 0,2) == "DR" ) : ?>
                            <a class="bbtn btn-sm btn-warning approve" href="ExportRecipeCSV.php?idm=<?= $_GET['idm']; ?>&id=<?= $data['id']; ?>&suffix=1&IMPORTAUTOCOUNTER=<?= $dataD['id']; ?>&rcode=<?= substr($data['recipe_code'],0,15); ?>&numbersuffix=<?= $data['idm']; ?>">
                                <i class="fa fa-cloud-upload" aria-hidden="true"></i> EXPORT <?= substr($data['recipe_code'],0,15); ?></a> =>
                            
                            <br><br>
                        <?php endif; ?>
                    </center>
                </div>
                <?php if(substr(strtoupper($data['idm']), 0, 2) == 'R2' or substr(strtoupper($data['idm']), 0, 2) == 'A2' or substr(strtoupper($data['idm']), 0, 2) == 'D2' or substr(strtoupper($data['idm']), 0, 2) == 'C2') : ?>
                        ...
                        *Detail Data yang akan di export : <br>
                        <table class="lookupST display nowrap">
                            ...
                            <tr>
                                ...
                                <td>: 
                                    <?php 
                                        if(substr($data['idm'], 0, 2) == 'R2' or substr($data['idm'], 0, 2) == 'A2' or substr($data['idm'], 0, 2) == 'D2' or substr($data['idm'], 0, 2) == 'C2'){
                                            echo substr($data['idm'], 1).'L';
                                        }elseif(substr($data['idm'], 0, 2) == 'DR' OR substr($data['idm'], 0, 2) == 'OB'){
                            ...
                            <tbody>
                                ...
                                <?php
                                    $q_frist_add = mysqli_query($con, "SELECT 
                                                                        ...
                                                                        left join tbl_matching b on b.no_resep = tsm.idm
                                                                        left join tbl_matching_detail a on a.id_matching = b.id
                                                                        where tsm.idm = '$data[idm]' and not tsm.soaping_sh = 0 and not tsm.soaping_tm = 0
                                                                        group by b.no_resep
                                                                        union 
                                                                        SELECT
                                                                            b.recipe_code as recipe_code,
                                                                        ...
                                                                        left join tbl_matching b on b.no_resep = tsm.idm
                                                                        left join tbl_matching_detail a on a.id_matching = b.id
                                                                        where tsm.idm = '$data[idm]' and not tsm.rc_sh = 0 and not tsm.rc_tm = 0
                                                                        group by b.no_resep
                                                                        union 
                                                                        SELECT
                                                                            b.recipe_code as recipe_code,
                                                                        ...
                                                                        left join tbl_matching b on b.no_resep = tsm.idm
                                                                        left join tbl_matching_detail a on a.id_matching = b.id
                                                                        where tsm.idm = '$data[idm]' and not tsm.bleaching_sh = 0 and not tsm.bleaching_tm = 0
                                                                        group by b.no_resep");
                                ?>
                ...
                <?php elseif (substr(strtoupper($data['idm']), 0, 2) == 'DR' OR substr(strtoupper($data['idm']), 0, 2) == 'OB') : ?>
                    <div class="row">
                        <div class="col-sm-6">
                                    ...
                                    <td>: 
                                        <?php 
                                            if(substr(strtoupper($data['idm']), 0, 2) == 'R2' or substr(strtoupper($data['idm']), 0, 2) == 'A2' or substr(strtoupper($data['idm']), 0, 2) == 'D2' or substr(strtoupper($data['idm']), 0, 2) == 'C2'){
                                                echo substr($data['idm'], 1).'L';
                                            }elseif(substr(strtoupper($data['idm']), 0, 2) == 'DR' OR substr(strtoupper($data['idm']), 0, 2) == 'OB'){
                                                echo substr($data['idm'], 2).'L';
                                            }
                                        ?>
                                    </td>
