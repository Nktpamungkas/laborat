...
b.no_warna, b.lebar, b.gramasi, b.qty_order, b.tgl_in, b.tgl_out, b.proses, b.buyer, a.final_matcher, 
a.create_resep, a.acc_ulang_ok,a.acc_resep1, a.acc_resep2, a.colorist1, a.colorist2, a.bleaching_tm, a.bleaching_sh, a.second_lr,
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select disabled class="form-control select_UserResep" required name="create_resep" id="create_resep">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select disabled class="form-control select_Koreksi" required name="acc_resep1" id="acc_resep1">
