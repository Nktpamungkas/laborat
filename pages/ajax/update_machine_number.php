...
if ($id && $no_machine !== '') {
    $res = mysqli_query($con, "SELECT is_old_data FROM tbl_preliminary_schedule WHERE id = $id LIMIT 1");
    ...
    if ($isOldData === 1) {
        ...
        // Jika TIDAK ADA old_data di mesin target, maka ubah data ini jadi -> (is_old_data = 0)
