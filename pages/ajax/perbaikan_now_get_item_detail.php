...
try {
    ...
    // ============= COLOR CODE & WARNA (sesuai NowForm lama) ============
    ...
    // Selaraskan nama warna dengan ITXVIEWBONORDER.WARNA (seperti NowForm lama)
    $sqlWarnaBon = "
        SELECT WARNA 
    ...
    // ============= BENANG (ITXVIEW_RAJUT, ITXVIEW_BOOKING_BLM_READY, ITXVIEW_BOOKING_NEW) ============
    $benang = '';
    ...
    if ($d_itxviewkk) {
        ...
        // 2) Booking belum ready (ITXVIEW_BOOKING_BLM_READY) dari ADDITIONALDATA*
        $sqlBooking = "
        ...
        // 3) Booking baru (ITXVIEW_BOOKING_NEW)
        $sqlBookingNew = "
            SELECT SUMMARIZEDDESCRIPTION
    ...
    echo json_encode([
        ...
        'recipe_code'  => '', // di NowForm diisi manual
        'no_po'        => $no_po,
        'kain'         => $kain,
        'warna'        => $warna_short,
        'no_warna'     => $no_warna,
