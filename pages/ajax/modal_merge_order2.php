...
a.create_resep, a.acc_ulang_ok,a.acc_resep1, a.acc_resep2, a.colorist1, a.colorist2, a.penanggung_jawab,
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control select_pjawab" required name="penanggung_jawab" id="penanggung_jawab">
										<option value="<?php echo $data['penanggung_jawab'] ?>" selected><?php echo $data['penanggung_jawab'] ?></option>
                                    </select>
                                </div>
                            </div>
                                <div class="form-group">
