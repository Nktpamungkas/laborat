...
b.tgl_delivery, b.note, b.jenis_matching, b.tgl_buat, b.tgl_update, b.created_by, a.bleaching_sh, a.bleaching_tm
...
<body>
    <div class="container col-md-12">
        ...
        <?php else : ?>
            <button class="btn btn pull-right" style="background-color: white; color: black; margin-bottom: 10px;"><strong><?php echo $data['idm'] ?> > Rejected</strong></button>
        <?php endif; ?>
    </div>
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <li class="disabled"><a data-toggle="tab" disabled href="#"><b>REJECTED</b></a></li>
        </ul>
    </div>
            ...
            <div id="input-status" class="tab-pane fade in active">
                <div class="row" style="margin-top: 20px">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <label for="Order" class="col-sm-3 control-label">No.Order</label>
                            <div class="col-sm-9">
